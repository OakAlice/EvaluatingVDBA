...
## 1: Volume of data
data <- fread(file.path(base_path, "Data/AccelerometerData", species, paste0(species, "_reformatted.csv")))
...
fwrite(hours_per_id, file.path(base_path, "Data/AccelerometerData", species, paste0(species, "_volume.csv")))
